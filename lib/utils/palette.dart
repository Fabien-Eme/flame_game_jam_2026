...
class Palette {
  ...
  static const Color shaderGreen = Color.fromARGB(255, 94, 255, 65);
  static const Color shaderRed = Color.fromARGB(255, 255, 0, 0);
  static const Color shaderGold = Color.fromARGB(255, 254, 239, 153);
}
